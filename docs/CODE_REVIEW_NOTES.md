...
| Gateway reconnect climb | **0.7.46** -- fast x3 then 3/7/12...40 s (not forever 5 s) |
...
| LCD/web Display+Log align | **0.7.51** -- LOG\|Serial; metrics format (dBm, deg, freeK); 55-line rings; web height cap |
